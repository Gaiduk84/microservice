...
public class AdminController {
    ...
    public String postAddUser(@Valid User user,
        ...
        attributes.addFlashAttribute("flashMessage", "Пользователь " + user.getFirstName() + " успешно добавлен!");
    ...
    public String updateUser(@PathVariable("id") long id,
        ...
        user.setId(id);
        userService.createOrUpdateUser(user);
        attributes.addFlashAttribute("flashMessage", "Пользователь " + user.getFirstName() + " успешно обновлен!");
        return "redirect:/admin/all";
    }
